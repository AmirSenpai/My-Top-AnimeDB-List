            ...
            <div>
                {AnimeInfos.map((item, index) => (
                    <div
                        key={index}
                        id={`item-${index}`}
                        className="flex flex-col m-auto gap-5 items-center justify-center border-2 border-black rounded-lg my-4"
                    >
                        <h2
                            id={`EngName-${index}`}
                            className="md:text-xl px-7 font-semibold -mb-4 mt-4 border-2 border-black bg-white p-1 rounded-lg md:w-auto w-auto text-sm text-center"
                        >
                            English Name: {item.EngName}
                        </h2>
                        <h2
                            id={`JpName-${index}`}
                            className="md:text-xl px-7 font-semibold -mb-2 mt-1 border-2 border-black bg-white p-1 rounded-lg md:w-auto w-auto text-sm text-center"
                        >
                        ...
                        <p
                            ...
                            className="md:text-xl px-5 font-semibold -mb-2 mt-1 border-2 border-black bg-emerald-300 p-1 rounded-lg md:w-auto w-auto text-sm text-center"
                        >
                            {item.Description}
                        </p>
                        <span
