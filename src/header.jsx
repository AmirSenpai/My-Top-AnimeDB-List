  ...
  return (
    <>
      <div className="bg-custom-100-0 md:w-full m-auto md:rounded-b-xl">
        ...
        ╘ Current Website's Version: {appVersion}
        <span className="md:text-sm text-xs flex flex-row pl-1 pt-2 pb-2">"click on the <MdOutlineUpdate className="text-white text-base mx-2"/> button to see Update-Log's Page"</span>
        </p>
        </span>
